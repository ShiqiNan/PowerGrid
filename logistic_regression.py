...
# Files
DATA_SET_PATH = "/Users/nanshiqi/downloads/anes_dataset.csv"
...
#def feature_target_histogram(feature_target_frequencies, feature_header):
    ...
    layout = go.layout(
                barmode = 'group',
                title = 'Feature :: ' + feature_header + ' Clinton Vs Dole votes Frequencies'),
                xaxis = dict(title="Feature :: " + feature_header ),
